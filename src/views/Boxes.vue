...
const boxes = ref([
  {
    id: 'box-1',
    name: '新手套組禮盒',
    image: '/assets/boxes/asset1.jpg',
    sourceType: '新創角色',
    obtain: '新創角色自帶的禮盒',
    items: [
      { name: '起點(7D)', rate: '100%', rarity: 'common' },
      { name: '前點(7D)', rate: '100%', rarity: 'common' },
      { name: '好友卡(7D)', rate: '100%', rarity: 'common' },
      { name: '新生耳環(7D)', rate: '100%', rarity: 'common' },
      { name: '新生眼鏡(7D)', rate: '100%', rarity: 'common' },
      { name: '歸回修練念珠(2倍)(1D)', rate: '100%', rarity: 'rare' },
      { name: '【亂好練】武器兌換券', rate: '100%', rarity: 'epic' }
    ],
    warning: '新手專屬，不可交易。'
  },
  {
    id: 'box-2',
    name: '基礎練功禮盒(7D)【LV.20】',
    image: '/assets/boxes/asset2.jpg',
    sourceType: '任務獎勵',
    obtain: '完成【劇情】『KO』硬梆幫-底迪',
    items: [
      { name: '歸回修練念珠(2倍) 5H', rate: '100%', rarity: 'rare' },
      { name: '+4 C級冬領服 30D', rate: '100%', rarity: 'uncommon' },
      { name: '【亂好練】武器兌換券', rate: '100%', rarity: 'epic' }
    ],
    warning: '基礎練功用。'
  },
  {
    id: 'box-3',
    name: '劍道部練功禮盒(7D)【LV.80】',
    image: '/assets/logo.jpg', 
    sourceType: '任務獎勵',
    obtain: '完成【劇情】『KO』滑輪高手',
    items: [
      { name: '歸回修練念珠(2倍) 5H', rate: '100%', rarity: 'rare' },
      { name: '+7 D級格鬥劍道服 30D', rate: '100%', rarity: 'uncommon' },
      { name: '【亂好練】武器兌換券', rate: '100%', rarity: 'epic' }
    ],
    warning: '等級80獎勵。'
  },
  {
    id: 'box-4',
    name: '劍道部練功禮盒(7D)【LV.100】',
    image: '/assets/boxes/asset1.jpg',
    sourceType: '任務獎勵',
    obtain: '完成【劇情】惹事生非的街道',
    items: [
      { name: '歸回修練念珠(2倍) 3D', rate: '100%', rarity: 'rare' },
      { name: '財團附屬停車場C禮盒 x2', rate: '100%', rarity: 'uncommon' },
      { name: '磨石、護貝劑 x2', rate: '100%', rarity: 'common' },
      { name: '異界磨石、高級護貝劑 x1', rate: '100%', rarity: 'rare' },
      { name: '青銅頭盔、白虎神戒、青龍神戒 7D', rate: '100%', rarity: 'epic' }
    ],
    warning: '財團附屬停車場C禮盒120等以下才能進。'
  },
  {
    id: 'box-5',
    name: '劍道部練功禮盒(7D)【LV.110】',
    image: '/assets/boxes/asset2.jpg',
    sourceType: '任務獎勵',
    obtain: '完成【劇情】變態三男的逆襲',
    items: [
      { name: '歸回修練念珠(2倍) 3D', rate: '100%', rarity: 'rare' },
      { name: '財團附屬停車場C禮盒 x2', rate: '100%', rarity: 'uncommon' },
      { name: '+5 C級武裝劍道服(正) 30D', rate: '100%', rarity: 'uncommon' }
    ],
    warning: '財團附屬停車場C禮盒120等以下才能進。'
  },
  {
    id: 'box-6',
    name: '劍道部練功禮盒(7D)【LV.120】',
    image: '/assets/logo.jpg',
    sourceType: '任務獎勵',
    obtain: '完成【劇情】賊頭殺殺殺',
    items: [
      { name: '歸回修練念珠(2倍) 3D', rate: '100%', rarity: 'rare' },
      { name: '財團附屬停車場D禮盒 x4', rate: '100%', rarity: 'uncommon' },
      { name: '磨石、護貝劑 x2', rate: '100%', rarity: 'common' },
      { name: '異界磨石、高級護貝劑 x2', rate: '100%', rarity: 'rare' }
    ],
    warning: '財團附屬停車場D禮盒150等以下才能進。'
  }
])
